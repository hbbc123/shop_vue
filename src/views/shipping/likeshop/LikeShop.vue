        ...
        <div class="sdfsdf_inof">
            <div class="shop_info_box" v-for="(item, key) in data.data" :key="key">
                <div class="shop_info_box_left por">
                    <div class="qu_bxo" @click="FnDelLike(item.store_id)">
                        取消关注
                    </div>
                    <div>
                    ...
                    <div class="dibu_box">
                        ...
                        <div>
                            <i class="bgsdf_icon kef_i kef_bgp"></i> 联系客服
                        </div>
                    </div>
                </div>
                    ...
                    <div class="shop_info_box_right_select">
                        ...
                        <div>
                            <div style="line-height: 1rem;margin-right: 0.5rem;">
                                ...
                                }}</span>/{{ (parseInt(item.data.length / 5) == item.data.length / 5 ? item.data.length
    : parseInt((item.data.length / 5) + 1)) }}
                    ...
                    <div class="img_box">
                        <div :style="{
                            ...
                            <div class="swioer_box" v-for="(son, son_key) in item.data" :key="son_key.commodity_info_id">
